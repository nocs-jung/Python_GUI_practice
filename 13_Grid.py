...
root.geometry("270x340+540+300")
root.resizable(False,False)

fontStyle = tkFont.Font(family="Lucida Grande", size=30)
result = Label(root, text="0", bg="white", anchor="se", relief="solid", height=1, font=fontStyle)
result.grid(row=0, column=0, sticky=N+E+W+S, padx=3, pady=3, columnspan=4)

#그리드를 이용한 키패드 만들기
#키패드 가장 윗줄 - function키 만들기
btn_F16 = Button(root, text="F16", width=7, height=2)
btn_F17 = Button(root, text="F17", width=7, height=2)
btn_F18 = Button(root, text="F18", width=7, height=2)
btn_F19 = Button(root, text="F19", width=7, height=2)
...
#clear줄
btn_Clear = Button(root, text="Clear", width=7, height=2)
btn_Equal = Button(root, text="=", width=7, height=2)
btn_Div = Button(root, text="/", width=7, height=2)
btn_Mul = Button(root, text="*", width=7, height=2)

btn_Clear.grid(row=2, column=0, sticky=N+E+W+S, padx=3, pady=3)
btn_Equal.grid(row=2, column=1, sticky=N+E+W+S, padx=3, pady=3)
btn_Div.grid(row=2, column=2, sticky=N+E+W+S, padx=3, pady=3)
btn_Mul.grid(row=2, column=3, sticky=N+E+W+S, padx=3, pady=3)

#7줄
btn_7 = Button(root, text="7", width=7, height=2)
btn_8 = Button(root, text="8", width=7, height=2)
btn_9 = Button(root, text="9", width=7, height=2)
btn_sub = Button(root, text="-", width=7, height=2)
...
#4줄
btn_4 = Button(root, text="4", width=7, height=2)
btn_5 = Button(root, text="5", width=7, height=2)
btn_6 = Button(root, text="6", width=7, height=2)
btn_add = Button(root, text="+", width=7, height=2)
...
#1줄
btn_1 = Button(root, text="1", width=7, height=2)
btn_2 = Button(root, text="2", width=7, height=2)
btn_3 = Button(root, text="3", width=7, height=2)
btn_enter = Button(root, text="enter", width=7, height=2)
...
#0줄
btn_0 = Button(root, text="0", width=7, height=2)
btn_point = Button(root, text=".", width=7, height=2)
